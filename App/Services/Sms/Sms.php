...
class Sms
{
	...
	function __construct($user, $pass)
	{
        ...
        $this->client = new nusoap_client("http://payamosh.com/class/sms/webservice3/server.php?wsdl");

        $this->client->soap_defencoding = 'UTF-8';
        $this->client->decode_utf8 = true;
	}

    public function SendSMS($Message, $SenderNumber, $Receptors)
    {
    ...
    public function SendMultipleSMS($Messages, $SenderNumbers, $Receptors)
    {
        ...
        $params = array(
            'fromNums'=>$SenderNumbers,
            'toNums'=>$Receptors,
            'messageContents'=>$Messages,
            'messageTypes'=>array_fill(0,count($Messages),0),
            'user'=>$this->Username,
            'pass'=>$this->Password
        );

        $response = $this->call("SendMultipleSMS", $params);
        return $response;
    }

    public function GetStatus($UniqueIDs)
	{
